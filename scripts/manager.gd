		...
		match playerNum:
			1:
				if teamP1[i] == null and team_slots[i].card != null:
					...
					if teamP1[i] != null and teamP1[i].colour != team_slots[i].card.colour:
						team_slots[i].card.colour = teamP1[i].colour
					if teamP1[i] != null and teamP1[i].hp != team_slots[i].card.hp:
						team_slots[i].card.hp = teamP1[i].hp
					if teamP1[i] != null and teamP1[i].attack != team_slots[i].card.attack:
						team_slots[i].card.attack = teamP1[i].attack
					if teamP1[i] != null and teamP1[i].x != team_slots[i].card.x:
						team_slots[i].card.x = teamP1[i].x
			2:
				if teamP2[i] == null and team_slots[i].card != null:
					team_slots[i].card.queue_free()
				else:
					if teamP2[i] != null and teamP2[i].colour != team_slots[i].card.colour:
						team_slots[i].card.colour = teamP2[i].colour
					if teamP2[i] != null and teamP2[i].hp != team_slots[i].card.hp:
						team_slots[i].card.hp = teamP2[i].hp
					if teamP2[i] != null and teamP2[i].attack != team_slots[i].card.attack:
						team_slots[i].card.attack = teamP2[i].attack
					if teamP2[i] != null and teamP2[i].x != team_slots[i].card.x:
						team_slots[i].card.x = teamP2[i].x
			3:
				if teamP3[i] == null and team_slots[i].card != null:
					team_slots[i].card.queue_free()
				else:
					if teamP3[i] != null and teamP3[i].colour != team_slots[i].card.colour:
						team_slots[i].card.colour = teamP3[i].colour
					if teamP3[i] != null and teamP3[i].hp != team_slots[i].card.hp:
						team_slots[i].card.hp = teamP3[i].hp
					if teamP3[i] != null and teamP3[i].attack != team_slots[i].card.attack:
						team_slots[i].card.attack = teamP3[i].attack
					if teamP3[i] != null and teamP3[i].x != team_slots[i].card.x:
						team_slots[i].card.x = teamP3[i].x
			4:
				if teamP4[i] == null and team_slots[i].card != null:
					team_slots[i].card.queue_free()
				else:
					if teamP4[i] != null and teamP4[i].colour != team_slots[i].card.colour:
						team_slots[i].card.colour = teamP4[i].colour
					if teamP4[i] != null and teamP4[i].hp != team_slots[i].card.hp:
						team_slots[i].card.hp = teamP4[i].hp
					if teamP4[i] != null and teamP4[i].attack != team_slots[i].card.attack:
						team_slots[i].card.attack = teamP4[i].attack
					if teamP4[i] != null and teamP4[i].x != team_slots[i].card.x:
						team_slots[i].card.x = teamP4[i].x
...
func convert_card_to_data(card):
	...
	if card == null:
		...
		elif card.card_name == "Mr. Randall":
			card_data["file_path"] = "res://scenes/mr_randall.tscn"
		...
		elif card.card_name == "Michael Jackson Thriller":
			card_data["file_path"] = "res://scenes/michael_jackson.tscn"
		elif card.card_name == "Michael Jackson Allegations":
			card_data["file_path"] = "res://scenes/michael_jackson.tscn"
		elif card.card_name == "Michael Jackson This Is It":
			card_data["file_path"] = "res://scenes/michael_jackson.tscn"
		elif card.card_name == "WatchMojo.com":
			card_data["file_path"] = "res://scenes/watch_mojo.tscn"
		else:
